...
const menuItems: MenuItem[] = [
  { icon: HiOutlineChartBar, label: 'Tổng quan', path: '/admin/dashboard' },
  { icon: HiOutlineUsers, label: 'Quản lý người dùng', path: '/admin/users' },
  { icon: HiOutlineAcademicCap, label: 'Quản lý môn học', path: '/admin/courses' },
  { icon: HiOutlineDocumentText, label: 'Quản lý tài liệu', path: '/admin/documents' },
  { icon: HiOutlineCog6Tooth, label: 'Cài đặt', path: '/admin/settings' },
];
