...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div
      className={`flex-1 overflow-y-auto custom-scrollbar ${isDark ? "bg-gray-900" : "bg-white"}`}
    >
      <div className="max-w-2xl mx-auto px-4 py-8">
        <h1
          className={`text-2xl font-medium mb-8 ${isDark ? "text-gray-100" : "text-gray-900"}`}
        >
          {t("profile.title")}
        </h1>
        ...
        {/* Avatar & Basic Info Card */}
        <div
          className={`rounded-2xl p-6 mb-6 border ${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"}`}
        >
          <div className="flex items-center gap-6">
            {/* Avatar */}
            <div className="relative">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 px-4 py-3 bg-gray-50 rounded-xl">
              ...
              <div>
                <div className="text-xs text-gray-400">Niên khóa</div>
                <div className="text-sm text-gray-700">
                  {user?.academic_year || "Chưa cập nhật"}
                </div>
              </div>
            </div>
          </div>
